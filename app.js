...
var config = require('./config');//全局的配置文件

if (!config.debug && config.oneapm_key) { //如果不选择本地调试，而且存在oneapm.key的时候,加载oneapm包
  require('oneapm');
}

require('colors'); //get color and style in your node.js console
